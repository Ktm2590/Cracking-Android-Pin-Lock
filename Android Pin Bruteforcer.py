...
#In password.key the md5 and sha1 hashes of the password are stored in one long string. I have split them up.
...
for i in range(10**(codelength)):
       if len(str(i)) < (codelength):
           #This fills the start of thew code with zeros 
